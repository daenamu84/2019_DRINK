						...
						<div class="col">
							...
							<div class="container border" style="padding: 15px;">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" id="vendor_stat_cd" class="form-control" name="vendor_stat_cd" <%if(request.getParameter("gubun")!=null){ %>readonly <%} %>  value="${data.VENDOR_STAT_NM}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                    	<select name="vendor_grd_cd" class="form-control" id="vendor_grd_cd" readonly>
